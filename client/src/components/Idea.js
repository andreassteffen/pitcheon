    ...
    return (
		<div className="card pink darken-1">
            ...
            <div className="card-action">
              ...
              <span className="socialinfo"><a className="tooltipped" data-position="bottom" data-delay="50" data-tooltip="Andreas Steffen<br>Daniel Freitag" data-tooltip-id="23d95f01-44d6-d9f7-b094-266f310966d2"><span className="white-text">2</span><i className="material-icons white-text tiny">face</i></a></span>
              <div className="right">
